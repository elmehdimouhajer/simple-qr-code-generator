...
if ( ! class_exists( 'Simple_Qr_Code_Generator' ) ) :
    ...
    final class Simple_Qr_Code_Generator
    {
        ...
        {
            _doing_it_wrong(__FUNCTION__, esc_html__('You are not allowed to clone this class.', 'simple-qr-code-generator'), '1.0.0');
        }
        ...
        {
            _doing_it_wrong(__FUNCTION__, esc_html__('You are not allowed to unserialize this class.', 'simple-qr-code-generator'), '1.0.0');
        }
